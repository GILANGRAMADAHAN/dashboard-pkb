...
<div class="card mb-4">
    <div class="card-header">
        <h5 class="mb-0">Input Data Pemilih</h5>
        @if(auth()->user() && !auth()->user()->isSuperAdmin())
        <small class="text-muted">Data yang Anda input akan terhubung dengan akun Anda</small>
        @endif
    </div>
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('pemilih.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('koordinator') is-invalid @enderror" id="koordinator" name="koordinator" value="{{ old('koordinator') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('petugas_lapangan') is-invalid @enderror" id="petugas_lapangan" name="petugas_lapangan" value="{{ old('petugas_lapangan') }}">
